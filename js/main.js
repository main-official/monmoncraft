...
(function () {
  ...
  function startGame(username) {
    ...
    seedPromise.then((seed) => {
      ...
      // Build the chunks around spawn first so the game can start right
      // away, then stream the rest of the (now much larger) world in
      // during idle time in the background.
      worldRenderer.buildAllChunks(controller.position.x, controller.position.z, () => {
